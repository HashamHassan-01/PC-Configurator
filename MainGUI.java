        ...
        printBtn.addActionListener(e -> {
            if(currentBuild.selectedCPU != null && currentBuild.selectedMotherboard != null) {
                ...
                if (choice == JOptionPane.YES_OPTION) {
                    ...
                    if(currentBuild.selectedRAM != null) storeData.deductStock(currentBuild.selectedRAM.getName());
                    if(currentBuild.selectedGPU != null) storeData.deductStock(currentBuild.selectedGPU.getName());
                    if(currentBuild.selectedCasing != null) storeData.deductStock(currentBuild.selectedCasing.getName());
                    refreshInventoryTable();
